...
import { 
    ...
    ArrowLeft, Heart, Zap, Clock, Phone
} from 'lucide-react';
...
export default function Login({
    ...
    return (
        <div className="min-h-screen w-full bg-[#F2F5F3] flex items-center justify-center p-3 sm:p-5 md:p-8 font-sans antialiased selection:bg-[#009E49] selection:text-white">
            <Head title={`Sign In - ${store_settings?.site_name || 'ChutirMart'}`} />

            {/* Main Split Container Card */}
            <div className="w-full max-w-[1240px] min-h-[720px] bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,158,73,0.08)] overflow-hidden grid grid-cols-1 lg:grid-cols-12 border border-slate-100">
                ...
                <div className="lg:col-span-6 p-6 sm:p-10 md:p-14 flex flex-col justify-between bg-white">
                    ...
                    <div className="max-w-[420px] w-full mx-auto my-auto space-y-5">
                            ...
                            <div className="flex items-center gap-2.5 min-w-0">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-[11px] text-gray-500 truncate font-bangla">
                                        লগইন ছাড়াই সরাসরি যেকোনো পণ্য অর্ডার করুন
                                    </p>
                                </div>
                            </div>
                            <Link 
                        ...
                        {/* Status Message */}
                        {status && (
                            <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-xl text-xs font-bold text-[#009E49]">
                                {status}
                            </div>
                        )}
                            ...
                            <div className="flex items-center justify-between pt-1">
                                ...
                                {canResetPassword && (
                                    <Link
                                        ...
                                        className="text-xs font-semibold text-[#009E49] hover:underline"
                                    >
                                        Forgot password?
                                    </Link>
                                )}
