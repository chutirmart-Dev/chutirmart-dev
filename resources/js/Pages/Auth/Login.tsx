...
export default function Login({
    ...
    const scrollToForm = () => {
        ...
        if (formElement) {
            ...
            setTimeout(() => {
                const firstInput = document.getElementById('login-email-input') as HTMLInputElement | null;
                firstInput?.focus();
            }, 350);
        }
    };
        ...
        <div className="min-h-screen w-full bg-[#F2F5F3] flex items-center justify-center p-3 sm:p-5 md:p-8 font-sans antialiased selection:bg-[#009E49] selection:text-white">
            ...
            <div className="w-full max-w-[1240px] lg:min-h-[720px] min-h-0 bg-white rounded-2xl sm:rounded-3xl shadow-[0_20px_60px_rgba(0,158,73,0.08)] overflow-hidden grid grid-cols-1 lg:grid-cols-12 border border-slate-100">
                ...
                <div className="lg:col-span-6 p-4 sm:p-8 md:p-14 flex flex-col justify-between bg-white">
                    ...
                    <div id="login-form-section" className="max-w-[420px] w-full mx-auto my-auto space-y-4 sm:space-y-5">
