...
export const Index: React.FC<IndexProps> = ({ orders, status = 'all', filters, couriers = [], stats }) => {
    ...
    const handleSearch = () => {
        router.get(route('admin.orders.index', { status }), { q: searchQuery }, { preserveState: true });
    };
                    ...
                    <div className="flex-1">
                        <form onSubmit={e => { e.preventDefault(); handleSearch(); }} className="relative">
                            ...
                            <input
                                ...
                                className="w-full h-11 pl-11 pr-4 rounded-xl border border-slate-200 bg-white text-[13.5px] sm:text-[14px] text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#009E49] focus:ring-2 focus:ring-[#009E49]/10 transition-all shadow-xs"
                            />
                        </form>
                    </div>
