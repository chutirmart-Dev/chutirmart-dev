        ...
        <AdminLayout>
                        ...
                        <AdminCard className="p-6">
                            ...
                            >
                                <div className="flex flex-col items-center justify-center py-7 px-6 text-center">
                                    ...
                                    <p className="text-[13px] font-bold text-[#1A1A2E] mb-0.5">Choose multiple gallery files from Media Library or PC</p>
            ...
            <MediaPickerModal
                ...
                onSelectMultiple={(items) => {
                    ...
                    toast.success(`${urls.length} image(s) added to gallery! 🖼️`);
                }}
            />
        </AdminLayout>
    );
